var map = [
    ...
    { regex: /\bpiss+/gi, exceptions: [] },
     ...
     //Tamil Words  With Basic insult
    {regex: /r+m+k/gi, exceptions:[] },
    {regex: /r.+m.+k./gi, extends:[] },
    {regex: /r+m+k+c+e+t/gi, exceptions: []},
    {regex: /Pa+ithi+yam/gi ,exceptions:[] },
    {regex: /Koo+mu+tta+i/gi,exceptions:[]},
    {regex: /Dha+nda+So+ru/gi,exceptions:[]},
    {regex: /tha+nda+so+ru/gi,exceptions:[]},
    {regex: /punnaku/gi,exceptions:[]},
    {regex: /so+tt+ai/gi,exceptions:[]},
